...
!NumpadAdd:: ; Alt + Numpad plus. you can change this to whatever you want. https://www.autohotkey.com/docs/KeyList.htm
    NVIDIA.SetDVCLevelEx(100, 3 - 1)
    ControlSend, msctls_trackbar323, {Right 100}, NVIDIA Control Panel ; assuming the gamma slider is at 1.00, it moves it right 100 times, to 2.00.
Return

!NumpadSub:: ; Alt + Numpad minus. you can change this to whatever you want. https://www.autohotkey.com/docs/KeyList.htm
    NVIDIA.SetDVCLevelEx(50, 3 - 1)
    ControlSend, msctls_trackbar323, {Left 100}, NVIDIA Control Panel ; assuming the gamma slider is at 2.00, it moves it left 100 times, to 1.00.
Return

/* 
NVIDIA API (for Digital Vibrance)
